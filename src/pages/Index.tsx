...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-aether-deep via-background to-aether-deep p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="animate-fade-in">
          <IntentInput onSubmit={processIntent} isProcessing={isProcessing} />
        </div>
